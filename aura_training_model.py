"""
AURA Virtual Assistant - Model Training Script
"""
...
model.save("aura_chat_model.h5")

with open("aura_tokenizer.pkl", "wb") as f:
    pickle.dump(tokenizer, f, protocol=pickle.HIGHEST_PROTOCOL)

with open("aura_label_encoder.pkl", "wb") as encoder_file:
